//
//  ContactCreateSocketAPIRequestModel.swift
//  WRMessenger
//
...
struct ContactCreateSocketAPIRequestModel: BaseSocketRequest, Encodable {

    var version: Int = Remote.versionAPI
    var type: NetworkType = .request
    var cmd: String = AppURL.Socket.Contact.create
    ...
    enum ObjectDataKeys: String, CodingKey {
        case key = "$"
        case object = "o"
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        var objectDataContainer = dataContainer.nestedContainer(keyedBy: ObjectDataKeys.self, forKey: .object)

        var userContainer = objectDataContainer.nestedContainer(keyedBy: ContactKeys.self, forKey: .object)
