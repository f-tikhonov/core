//
//  ContactGetAllSocketAPIRequestModel.swift
//  WRMessenger
//
...
struct ContactGetAllSocketAPIRequestModel: BaseSocketRequest, Encodable {

    var version: Int = Remote.versionAPI
    var type: NetworkType = .request
    var cmd: String = AppURL.Socket.Contact.getAll
