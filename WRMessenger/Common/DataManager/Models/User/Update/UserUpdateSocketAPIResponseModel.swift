//
//  UserUpdateSocketAPIResponseModel.swift
//  WRMessenger
//
...
struct UserUpdateSocketAPIResponseModel: BaseSocketResponse, Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        dataType = try dataContainer.decode(String.self, forKey: .key)
