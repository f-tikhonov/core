//
//  UserSearchSocketAPIRequestModel.swift
//  WRMessenger
//
...
struct UserSearchSocketAPIRequestModel: BaseSocketRequest, Encodable {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try userContainer.encode(searchValue, forKey: .searchValue)
    }

    internal init (searchValue: String) {
